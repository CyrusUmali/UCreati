export default function ServicesSVG() {
    return (
      ...
      >
        {/* subtle grid lines */}
        <line x1="480" y1="0" x2="480" y2="800" stroke="var(--primary)" strokeWidth="0.5" opacity="0.06" className="d-grid-v" />
        <line x1="960" y1="0" x2="960" y2="800" stroke="var(--primary)" strokeWidth="0.5" opacity="0.04" className="d-grid-v" />
        <line x1="0" y1="400" x2="1440" y2="400" stroke="var(--primary)" strokeWidth="0.5" opacity="0.06" className="d-grid-h" />
  
        {/* LEFT CLUSTER */}

        <g transform="translate(-120, 50)">
    <g className="d-float-a" style={{ transformOrigin: "0px 100px" }} transform="scale(0.3)">
  <path fill="var(--surface)" d="M-30,260 L-190,100 c-18-18-18-46,0-64 L-30,-60 c18-18,46-18,64,0 L194,164 c18,18,18,46,0,64 L34,392 C16,410,-12,410,-30,392 Z" opacity="0.9" />
  <path fill="none" stroke="var(--primary)" strokeWidth="1.5" className="d-outline-a"
    d="M-26,272 L-186,112 c-18-18-18-46,0-64 L-26,-48 c18-18,46-18,64,0 L198,176 c18,18,18,46,0,64 L38,404 C20,422,-8,422,-26,404 Z" />
        ...
        <g className="d-float-c" style={{ transformOrigin: "80px 420px" }}>
          <path fill="var(--primary)" className="d-fill-b"
          ...
          <path fill="none" stroke="var(--primary)" strokeWidth="1" opacity="0.55"
        ...
        <g className="d-float-b" style={{ transformOrigin: "1380px 480px" }}>
          ...
          <path fill="none" stroke="var(--primary)" strokeWidth="1.5" className="d-outline-b"
        ...
        <g className="d-float-e" style={{ transformOrigin: "1160px 220px" }}>
          <path fill="var(--primary)" className="d-fill-c"
        ...
        {/* <g className="d-drift" style={{ transformOrigin: "940px 380px" }}>
          <path fill="var(--primary-p)" opacity="0.75"
        ...
        <g className="d-mini" style={{ transformOrigin: "1070px 560px" }}>
          <path fill="var(--border)" opacity="0.82"
        ...
        <polygon fill="var(--accent)" className="d-accent" points="1050,530 1046,558 1030,542" />
  
        {/* ripple rings — left */}
        <ellipse cx="0" cy="100" rx="200" ry="200" fill="none" stroke="var(--primary)" strokeWidth="0.5" opacity="0"
        ...
        {/* ripple rings — right */}
        <ellipse cx="1440" cy="480" rx="190" ry="190" fill="none" stroke="var(--primary)" strokeWidth="0.5" opacity="0"
